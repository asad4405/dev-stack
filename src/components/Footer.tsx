                ...
                <div className="max-w-7xl mx-auto px-4">
                    <div className="flex flex-col lg:flex-row justify-between gap-8 text-center lg:text-left">
                        ...
                        <div className="space-y-3 max-w-xs mx-auto lg:mx-0">
                            ...
                            <div className="flex justify-center lg:justify-start gap-3 font-medium text-gray-700">
                        ...
                        <div className="hidden lg:grid grid-cols-3 gap-12 text-left">
                            ...
                            <div className="space-y-2">
                                ...
                                <a href="#" className="block hover:text-pink-500">Privacy Policy
                                </a>
                                <a href="#" className="block hover:text-pink-500">Terms of Service
                                </a>
                            </div>
                        </div>
                    </div>

                    <div className="border-t border-gray-100 mt-8 pt-6 flex flex-col sm:flex-row justify-between items-center gap-2 text-xs text-gray-400">
